...
<head>
    ...
    <style amp-custom>
        ...
        *:focus {
        ...
        .item-wrapper:hover .item-img .btn {
            opacity: 1;
            bottom: 1rem;
        }
        ...
        .amp-shop .lightbox-wrapper .lightbox-bg {
            height: 100%;
            width: 100%;
        ...
        .cid-rDfQmnbl0J .navbar {
            background: #efefef;
            justify-content: center;
        }

        .cid-rDfQmnbl0J .navbar>.container,
        .cid-rDfQmnbl0J .navbar>.container-fluid {
            justify-content: flex-end;
        }

        .cid-rDfQmnbl0J .navbar-brand {
            min-width: 260px;
        }

        .cid-rDfQmnbl0J .nav-link {
            margin: 0;
        }

        .cid-rDfQmnbl0J .link.dropdown-toggle:after {
            position: absolute;
            top: 48%;
            right: 10px;
        }

        .cid-rDfQmnbl0J .dropdown-menu .dropdown-toggle:after {
            right: 10px;
        }
        ...
        .cid-rDfQmnbl0J .link:hover {
            border-top: 2px solid #2ca438;
            color: #2ca438;
        }

        .cid-rDfQmnbl0J .navbar .navbar-collapse {
            justify-content: center;
            width: 100%;
        }
        ...
        .cid-rDfQmnbl0J a:before {
            content: none;
        }

        .cid-rDfQmnbl0J .dropdown-item:hover,
        .cid-rDfQmnbl0J .nav-link:hover,
        .cid-rDfQmnbl0J .navbar-caption:hover {
            color: #2ca438;
        }
        ...
        .cid-rDfQmnbl0J .dropdown-item.active,
        .cid-rDfQmnbl0J .dropdown-item:active {
            background-color: transparent;
        }

        .cid-rDfQmnbl0J .dropdown-menu {
            background: #efefef;
        }

        .cid-rDfQmnbl0J .hamburger span {
            background-color: #232323;
        }

        .cid-rDfQmnbl0J .builder-sidebar {
            background-color: #efefef;
        }

        .cid-rDfQmnbl0J .close-sidebar:focus {
            outline: 2px auto #2ca438;
        }

        .cid-rDfQmnbl0J .close-sidebar span {
            background-color: #232323;
        }
        ...
        .cid-rDfVeBAm0e .mbr-section-title {
            color: #000f36;
        }

        .cid-rDfVeBAm0e .container-fluid {
            padding: 0;
        }

        .cid-rDfVeBAm0e .content {
            max-width: 800px;
            margin: auto;
        }

        .cid-rDfVeBAm0e .mbr-section-btn,
        .cid-rDfVeBAm0e .mbr-text {
            color: #000f36;
        }

        .cid-rDfVeBAm0e amp-img {
            object-fit: cover;
            height: 100%;
        }

        .cid-rDfVeBAm0e .image-block {
            height: 100%;
        }
        ...
        .cid-rDgIqLUwpO .mbr-section-title {
            color: #000f36;
        }

        .cid-rDgIqLUwpO .container-fluid {
            padding: 0;
        }

        .cid-rDgIqLUwpO .content {
            max-width: 650px;
            margin: auto;
        }

        .cid-rDgIqLUwpO .mbr-section-btn,
        .cid-rDgIqLUwpO .mbr-text {
            color: #000f36;
        }

        .cid-rDgIqLUwpO amp-img {
            object-fit: cover;
            height: 100%;
        }

        .cid-rDgIqLUwpO .image-block {
            height: 100%;
        }

        .cid-rDgIqLUwpO .img-col {
            padding: 0;
        }

        .cid-rDgIqLUwpO .mbr-text3 {
            text-decoration: underline;
            color: #2ca438;
        }

        .cid-rDgIqLUwpO .mbr-text2 {
            color: #000f36;
        }
        ...
        .cid-rDgIqnL3no .mbr-section-title {
            color: #000f36;
        }

        .cid-rDgIqnL3no .container-fluid {
            padding: 0;
        }

        .cid-rDgIqnL3no .content {
            max-width: 650px;
            margin: auto;
        }

        .cid-rDgIqnL3no .mbr-section-btn,
        .cid-rDgIqnL3no .mbr-text {
            color: #000f36;
        }

        .cid-rDgIqnL3no amp-img {
            object-fit: cover;
            height: 100%;
        }

        .cid-rDgIqnL3no .image-block {
            height: 100%;
        }

        .cid-rDgIqnL3no .img-col {
            padding: 0;
        }

        .cid-rDgIqnL3no .mbr-text3 {
            text-decoration: underline;
            color: #2ca438;
        }

        .cid-rDgIqnL3no .mbr-text2 {
            color: #000f36;
        }
        ...
        .cid-rDgIwy0UWr:hover {
            background-color: #2ca438;
        }

        .cid-rDgIwy0UWr a:hover {
            color: inherit;
        }
        ...
        .cid-rDgJWgXkJp .mbr-section-title {
            color: #000f36;
        }

        .cid-rDgJWgXkJp .mbr-text3 {
            text-decoration: underline;
            color: #2ca438;
        }
        ...
        .cid-rDgIcyPxhQ .mbr-section-title {
            color: #000f36;
        }

        @media (min-width: 992px) {
            .cid-rDgIcyPxhQ .content {
                max-width: 550px;
                margin: auto;
            }
        }

        .cid-rDgIcyPxhQ amp-img {
            object-fit: cover;
            height: 100%;
        }

        .cid-rDgIcyPxhQ .image-block {
            height: 100%;
        }

        .cid-rDgIcyPxhQ .mbr-text3 {
            text-decoration: underline;
            color: #2ca438;
        }

        .cid-rDgIcyPxhQ .mbr-section-subtitle {
            color: #2ca438;
        }

        .cid-rDgIcyPxhQ .mbr-text2 {
            color: #000f36;
        }
        ...
        .cid-rDgIda7tDo .mbr-section-title {
            color: #2ca438;
        }

        @media (min-width: 992px) {
            .cid-rDgIda7tDo .content {
                max-width: 550px;
                margin: auto;
            }
        }

        .cid-rDgIda7tDo amp-img {
            object-fit: cover;
            height: 100%;
        }

        .cid-rDgIda7tDo .image-block {
            height: 100%;
        }

        .cid-rDgIda7tDo .mbr-text3 {
            text-decoration: underline;
            color: #2ca438;
        }

        .cid-rDgIda7tDo .mbr-section-subtitle {
            color: #2ca438;
        }

        .cid-rDgIda7tDo .mbr-text2 {
            color: #000f36;
        }
        ...
        .cid-rDgIal9HPF .mbr-section-title {
            color: #000f36;
        }

        .cid-rDgIal9HPF .mbr-text3 {
            text-decoration: underline;
            color: #2ca438;
        }
        ...
        .cid-rDgIal9HPF .card-title {
            color: #000f36;
        }

        .cid-rDgIal9HPF .mbr-text2 {
            color: #000f36;
        }
        ...
        .cid-rDgIgpFcdX .content {
            max-width: 800px;
            margin: auto;
        }

        .cid-rDgIgpFcdX .map-col {
            padding: 0;
        }

        .cid-rDgIgpFcdX .google-map {
            height: 30rem;
            width: 100%;
            position: relative;
        }

        .cid-rDgIgpFcdX .google-map iframe {
            height: 100%;
            width: 100%;
        }

        .cid-rDgIgpFcdX .google-map [data-state-details] {
            color: #6b6763;
            font-family: Montserrat;
            height: 1.5em;
            margin-top: -0.75em;
        ...
        .cid-rDgIgpFcdX .google-map[data-state] {
            background: #e9e5dc;
        }

        .cid-rDgIgpFcdX .google-map[data-state="loading"] [data-state-details] {
            display: none;
        }
        ...
        .cid-rDgIgpFcdX .mbr-text,
        .cid-rDgIgpFcdX .mbr-section-btn {
            color: #000f36;
        }
        ...
        .cid-rDgIlmN7Lc .mbr-row {
            border-bottom: 6px solid #333f5e;
        }

        .cid-rDgIlmN7Lc a:hover {
            color: #2ca438;
        }
...
<body><amp-sidebar id="sidebar" class="cid-rDfQmnbl0J" layout="nodisplay" side="right">
...
href="https://enidservices.com/pesas">Encuentra tu equipo ya!</a></div>
    ...
    <section class="menu1 menu horizontal-menu cid-rDfQmnbl0J" id="menu1-1b">
...
href="https://enidservices.com/pesas">Encuentra tu equipo ya!</a></div>
    ...
    <section class="header3 cid-rDfVeBAm0e" id="header3-1j">
...
href="https://enidservices.com/pesas"></a>
    ...
    <section class="Features4 cid-rDgIqLUwpO" id="features4-2k">
